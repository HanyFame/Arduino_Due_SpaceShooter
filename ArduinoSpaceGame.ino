...
void drawSpace()
{
  ...
  {        
    ...
    tft.drawPixel(random(0,320), random(0, 190), ILI9341_WHITE);
  }
}
...
void loop()
{
	while (true)
	{
        ...
        //tft.fillRect(0, 20, 320, 50, ILI9341_BLACK);
        //tft.printAlignedOffseted("LEFT", gTextAlignTopCenter, 0, 30);
        ...
        //tft.fillRect(0, 20, 320, 50, ILI9341_BLACK);
        //tft.printAlignedOffseted("CENTER", gTextAlignTopCenter, 0, 30);
        ...
        //tft.fillRect(0, 20, 320, 50, ILI9341_BLACK);
        //tft.printAlignedOffseted("RIGHT", gTextAlignTopCenter, 0, 30);
